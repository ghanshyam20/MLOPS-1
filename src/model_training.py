...
logger=get_logger(__name__)  ############ for initailizing logger ##############
...
class ModelTraining:
    def __init__(self,train_path,test_path,model_output_path):
        ...
        ########## initailizing model parameters also ############### 
    ...
    def train_lgbm(self,X_train,y_train):
        try:
            logger.info("Initailizing our model")
            ...
            logger.info("Hyperparamter Tuning is Completed Successfully")
...
############## Now its time to save our model ################
    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info("Loggin the training and testing dataset to MLFLOW")
            ...
            logger.error(f"Error in model trainign training pipelines {e}")
